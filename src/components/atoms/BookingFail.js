    ...
    return (
        <View style={{position:'absolute', top:0, left:0, right:0, bottom:0, ...styles.rowCenter, zIndex:1000}} >
            ...
            <View style={{width:"80%", height:scale(250), backgroundColor:"#fff", borderRadius:scale(10), alignItems:'center', justifyContent:'center'}} >
                ...
                <Text allowFontScaling={false} style={{color:'#000',fontFamily:'Montserrat-Bold',marginTop:scale(20), fontSize:scale(11)}}>Sorry for the trouble!!</Text>
                <Text allowFontScaling={false} style={{color:'#939393',fontFamily:'Montserrat-Medium',marginTop:scale(10), fontSize:scale(10), textAlign:'center', paddingHorizontal:scale(20)}}>Your purchage is not successfully place!! Please try after some time</Text>

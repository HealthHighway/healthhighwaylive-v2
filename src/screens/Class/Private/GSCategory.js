...
class GSCategory extends React.Component {
            ...
            <View style={{flex:1, backgroundColor:'#fff'}} >
                ...
                <ScrollView style={{flex:1}}>
                    <View style={{height:scale(60),backgroundColor:'white', flexDirection:'row',paddingHorizontal:scale(20), ...styles.shadowStyle}} >
                        <BackHeaderWithTitleCentered onBackPress={() => this.props.navigation.goBack()} showBackBtn={true} showTitle={true} title="Get in Shape"  />
                    </View>
                    ...
                    <ProblemCheckBox 
                        problems={this.state.problems}
                        myProblem={"Core Exercises"}
                        onPress={(myProblem) => this.handleSetUnsetProblem(myProblem)}
                    />

                    <ProblemCheckBox 
                        problems={this.state.problems}
                        myProblem={"Strength Training"}
                        onPress={(myProblem) => this.handleSetUnsetProblem(myProblem)}
                    />
...
export default connect(null, { addPrivateInfo })(GSCategory)